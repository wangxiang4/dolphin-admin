export default {
  api: {
    ...
    errMsg408: '网络请求超时!',
    errMsg424: '令牌过期,请重新登录!',
    errMsg426: '您输入了无效的用户名或密码,请记住用户名和密码区分大小写。',
    errMsg428: '验证码错误,请重新输入!',
    errMsg429: '请求过频繁!',
  ...
  login: {
    ...
    signInTitle: '海豚生态计划-海豚开发平台生态圈',
    signInDesc: '完全免费开源,包括高级功能,打造一个web端,安卓端,ios端的一个海豚架构平台生态圈',
    policy: '我同意xxx隐私政策',
